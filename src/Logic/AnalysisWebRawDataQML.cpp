...
AnalysisWebRawDataQML::AnalysisWebRawDataQML(const QByteArray &webRawData, const QString &templateName, const QString &templateCode)
{
    setValue(webRawData, templateName, templateCode);
}

void AnalysisWebRawDataQML::setValue(const QByteArray &webRawData, const QString &templateName, const QString &templateCode)
{
...
void AnalysisWebRawDataQML::setValue(const AnalysisWebRawDataQML *other)
{
    this->templateName = other->templateName;
    this->templateCode = other->templateCode;
    this->questionsCountsStrList = other->questionsCountsStrList;
    this->answerDataList = other->answerDataList;
}

QString AnalysisWebRawDataQML::getAnswerAndAnalysisHtml(const qsizetype index) const
{
    QString webStr;
...
QString AnalysisWebRawDataQML::getAnswerHtml(const qsizetype index) const
{
    QString webStr;
...
QString AnalysisWebRawDataQML::getQuestionHtml(const qsizetype index) const
{
    QString webStr;
...
QList<AnswerDetailData> AnalysisWebRawDataQML::getCountAndAnswer(const qsizetype index) const
{
...
void AnalysisWebRawDataQML::analysis(const QByteArray &webRawData)
{
...
template<typename f>
void AnalysisWebRawDataQML::callFunc(const QJsonArray &jsonArray, const qsizetype index, f func)
{
    //不知道起啥名了,用于简化流程
...
void AnalysisWebRawDataQML::callFunc(const QJsonArray &jsonArray, const qsizetype index, f1 func1, f2 func2)
{
    //不知道起啥名了,用于简化流程
