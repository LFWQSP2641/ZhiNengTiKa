...
void UpdateChecker::downloadNewestVersion()
{
    ...
    connect(newestVersionReply, &QNetworkReply::finished, [newestVersionReply, this]
    {
        ...
        QFile file(Global::tempPath().append(QStringLiteral("/")).append(QStringLiteral("newVersion.apk")));
...
{
#ifdef Q_OS_ANDROID
    CallAndroidNativeComponent::installApk(Global::tempPath().append(QStringLiteral("/")).append(QStringLiteral("newVersion.apk")));
#endif // Q_OS_ANDROID
}
